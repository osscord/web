  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-3 mt-52 p-5 md:py-10 md:px-32">
        <h2 className="text-2xl font-bold mt-6">Agreement to Terms</h2>
        <p>
          These Terms of Use constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity (“you”) and
          masked#0959, doing business as osscord ("osscord", “we”, “us”, or
          “our”), concerning your access to and use of the osscord bot as well
          as any other media form, website, media channel, mobile website or
          mobile application related, linked, or otherwise connected thereto
          (collectively, the “Bot”). You agree that by accessing the Bot, you
          ...
          EXPRESSLY PROHIBITED FROM USING THE BOT AND YOU MUST DISCONTINUE USE
          IMMEDIATELY.
        </p>
        <p>
          ...
          applicable Terms every time you use our Bot so that you understand
          ...
          Terms of Use by your continued use of the Bot after the date such
          revised Terms of Use are posted.
        </p>
        <p>
          The information provided on the Bot is not intended for distribution
          ...
          access the Bot from other locations do so on their own initiative and
          are solely responsible for compliance with local laws, if and to the
          extent local laws are applicable.
        </p>
        <p>
          The Bot is not tailored to comply with industry-specific regulations
          ...
          Bot. You may not use the Bot in a way that would violate the
          Gramm-Leach-Bliley Act (GLBA).
        </p>
        <p>
          The Bot is intended for users who are at least 13 years of age. All
          users who are minors in the jurisdiction in which they reside
          (generally under the age of 18) must have the permission of, and be
          directly supervised by, their parent or guardian to use the Bot. If
          you are a minor, you must have your parent or guardian read and agree
          to these Terms of Use prior to you using the Bot.
        </p>
        ...
        <p>
          Unless otherwise indicated, the Bot is our proprietary property and
          all source code, databases, functionality, software, website designs,
          audio, video, text, photographs, and graphics on the Bot
          ...
          conventions. The Content and the Marks are provided on the Bot “AS IS”
          for your information and personal use only. Except as expressly
          provided in these Terms of Use, no part of the Bot and no Content or
        ...
        <p>
          ...
          limited license to access and use the Bot and to download or print a
          copy of any portion of the Content to which you have properly gained
          access solely for your personal, non-commercial use. We reserve all
          rights not expressly granted to you in and to the Bot, the Content and
          the Marks.
        </p>
        <h2 className="text-2xl font-bold mt-6">User Representations</h2>
        <p>
          ...
          parental permission to use the Bot; (4) you will not access the
          Discord Bot through automated or non-human means, whether through a
          bot, script or otherwise; (5) you will not use the Bot for any illegal
          or unauthorized purpose; and (6) your use of the Bot will not violate
          any applicable law or regulation.
        </p>
        <p>
          If you provide any information that is untrue, inaccurate, not
          current, or incomplete, we have the right to suspend or terminate your
          account and refuse any and all current or future use of the Bot (or
          any portion thereof).
        </p>
        ...
        <p>As a user of the Bot, you agree not to:</p>
        <ul className="list-disc list-outside pl-10">
          <li>
            Systematically retrieve data or other content from the Bot to create
          ...
          <li>
            ...
            features of the Bot, including features that prevent or restrict the
            use or copying of any Content or enforce limitations on the use of
            the Bot and/or the Content contained therein.
          </li>
          <li>
          ...
          <li>
            Use any information obtained from the Bot in order to harass, abuse,
          ...
          <li>
            Use the Bot in a manner inconsistent with any applicable laws or
            regulations.
          </li>
          ...
          <li>
            ...
            Bot or modifies, impairs, disrupts, alters, or interferes with the
            use, features, functions, operation, or maintenance of the Bot.
          </li>
          <li>
          ...
          <li>
            Interfere with, disrupt, or create an undue burden on the Bot or the
            networks or services connected to the Bot.
          </li>
          <li>
          ...
          <li>
            Attempt to bypass any measures of the Bot designed to prevent or
            restrict access to the Bot, or any portion of the Bot.
          </li>
          <li>
          ...
          <li>
            ...
            in any way making up a part of the Bot.
          </li>
          <li>
          ...
          <li>
            Make any unauthorized use of the Bot, including collecting usernames
          ...
          <li>
            Use the Bot as part of any effort to compete with us or otherwise
            use the Bot and/or the Content for any revenue-generating endeavor
            or commercial enterprise.
          </li>
          <li>Exchange virtual currency for real value in any way.</li>
          <li>Initiate illegitimate chargebacks.</li>
          <li>Use any type of unauthorized automation within Discord.</li>
          <li>Use the bot for unauthorized advertisements.</li>
        </ul>
        <h2 className="text-2xl font-bold mt-6">Contribution License</h2>
        <p>
        ...
        <p>
          By submitting suggestions or other feedback regarding the Bot, you
        ...
        <p>
          ...
          in your Contributions provided by you in any area on the Bot. You are
          solely responsible for your Contributions to the Bot and you expressly
        ...
        <h2 className="text-2xl font-bold mt-6">Submissions</h2>
        <p>
          You acknowledge and agree that any questions, comments, suggestions,
          ideas, feedback, or other information regarding the Bot
        ...
        <p>
          ...
          accessed through the Bot or any Third-Party Content posted on,
          available through, or installed from the Bot, including the content,
          ...
          leave the Bot and access the Third-Party Websites or to use or install
          ...
          practices, of any website to which you navigate from the Bot or
          relating to any applications you use or install from the Bot. Any
        ...
        <h2 className="text-2xl font-bold mt-6">Bot Management</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold mt-6">Privacy Policy</h2>
        <p>
          We care about data privacy and security. Please review our Privacy
          Policy:{" "}
          <a href="https://osscord.xyz/privacy" target="_blank">
            https://osscord.xyz/privacy
          </a>
          . By using the Bot, you agree to be bound by our Privacy Policy, which
          is incorporated into these Terms of Use. Please be advised the Bot is
          hosted in the United States. If you access the Bot from any other
          ...
          in the United States, then through your continued use of the Bot, you
          ...
          consent, we will delete that information from the Bot as quickly as is
          reasonably practical.
        </p>
        <h2 className="text-2xl font-bold mt-6">Term and Termination</h2>
        <p>
          These Terms of Use shall remain in full force and effect while you use
          the Bot. WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS OF USE,
          WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR
          LIABILITY, DENY ACCESS TO AND USE OF THE BOT (INCLUDING BLOCKING
        ...
        <p>
          ...
          bot at any time or for any reason at our sole discretion without
          notice. However, we have no obligation to update any information on
          our bot. We also reserve the right to modify or discontinue all or
          part of the bot without notice at any time. We will not be liable to
          you or any third party for any modification, price change, suspension,
          or discontinuance of the bot.
        </p>
        <p>
          We cannot guarantee the bot will be available at all times. We may
          experience hardware, software, or other problems or need to perform
          maintenance related to the bot, resulting in interruptions, delays, or
          errors. We reserve the right to change, revise, update, suspend,
          discontinue, or otherwise modify the bot at any time or for any reason
          ...
          access or use the bot during any downtime or discontinuance of the
          bot. Nothing in these Terms of Use will be construed to obligate us to
          maintain and support the bot or to supply any corrections, updates, or
          releases in connection therewith.
        </p>
        <h2 className="text-2xl font-bold mt-6">Corrections</h2>
        <p>
          There may be information on the bot that contains typographical
          errors, inaccuracies, or omissions, including descriptions, pricing,
          availability, and various other information. We reserve the right to
          correct any errors, inaccuracies, or omissions and to change or update
          the information on the bot at any time, without prior notice.
        </p>
        ...
        <p>
          ...
          EXPRESS OR IMPLIED, IN CONNECTION WITH THE BOT AND YOUR USE THEREOF,
          INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF
          MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND
          NON-INFRINGEMENT. WE MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE
          ACCURACY OR COMPLETENESS OF THE BOT'S CONTENT OR THE CONTENT OF ANY
          WEBSITES LINKED TO THE BOT AND WE WILL ASSUME NO LIABILITY OR
          RESPONSIBILITY FOR ANY (1) ERRORS, MISTAKES, OR INACCURACIES OF
          CONTENT AND MATERIALS, (2) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY
          NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE BOT,
          ...
          THE WEBSITE, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH
          MAY BE TRANSMITTED TO OR THROUGH THE BOT BY ANY THIRD PARTY, AND/OR
          (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY
          LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY
          CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE BOT.
          ...
          THE BOT, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE APPLICATION
        ...
        <h2 className="text-2xl font-bold mt-6">Limitations of Liability</h2>
        <p>
          IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE
          TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL,
          EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST
          PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR
          USE OF THE BOT, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF
        ...
        <h2 className="text-2xl font-bold mt-6">Indemnification</h2>
        <p>
          ...
          toward any other user of the Bot with whom you connected via the Bot.
        ...
        <h2 className="text-2xl font-bold mt-6">User Data</h2>
        <p>
          We will maintain certain data that you transmit to the Bot for the
          purpose of managing the performance of the Bot, as well as data
          relating to your use of the Bot. Although we perform regular routine
          backups of data, you are solely responsible for all data that you
          transmit or that relates to any activity you have undertaken using the
          Bot. You agree that we shall have no liability to you for any loss or
        ...
        <p>
          ...
          electronically, via email and on the Bot, satisfy any legal
          ...
          OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIA THE BOT. You
        ...
        <h2 className="text-2xl font-bold mt-6">Miscellaneous</h2>
        <p>
          These Terms of Use and any policies or operating rules posted by us on
          the website or in respect to the Bot constitute the entire agreement
          ...
          Use or use of the Bot. You agree that these Terms of Use will not be
        ...
        <p>
          ...
          further information regarding use of the Bot, please contact us at:
        </p>
        <p>
          <span className="font-bold">Email: </span>support@osscord.xyz
        </p>
        <p>
          <span className="font-bold">Discord: </span>masked#0959
        </p>
      </div>
    </div>
  );
